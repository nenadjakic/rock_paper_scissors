        ...
        .with_children(|parent| {
            ...
            parent.spawn(NodeBundle {
                ...
                .with_children(|parent| {
                    ...
                    parent.spawn(TextBundle::from_section("Author", header_style.clone())
                        .with_style(Style {
                            margin: header_margin.clone(),
                            ..default()
                        }));

                    parent.spawn(TextBundle::from_section("Nenad Jakic", body_style.clone())
                        .with_style(Style {
                            margin: body_margin.clone(),
                            ..default()
                        }));

                    parent.spawn(TextBundle::from_section("Images", header_style.clone())
                        .with_style(Style {
                            margin: header_margin.clone(),
                            ..default()
                        }));

                    parent.spawn(TextBundle::from_section("Downloaded from web site: https://icons8.com, free for personal and commercial use licence.", body_style.clone())
                        .with_style(Style {
                            margin: body_margin.clone(),
                            ..default()
                        }));

                    parent.spawn(TextBundle::from_section("Sounds", header_style.clone())
                        .with_style(Style {
                            margin: header_margin.clone(),
                            ..default()
                        }));

                    parent.spawn(TextBundle::from_section("Downloaded from web site: https://pixabay.com/, free for use licence.", body_style.clone())
                        .with_style(Style {
                            margin: body_margin.clone(),
                            ..default()
                        }));

                    parent.spawn(TextBundle::from_section("Fonts", header_style.clone())
                        .with_style(Style {
                            margin: header_margin.clone(),
                            ..default()
                        }));
...
pub fn confirm_button_action(keyboard_input: Res<Input<KeyCode>>, mut app_state: ResMut<NextState<AppState>>,
